...
export const domSelectionAndTraversal = {
  title: 'DOM selection & traversal',
  date: '2022.01.09',
  tagsArr: ['JavaScript', 'CSS', 'jQuery', 'style', 'DOM'],
  postParts: [
    {
      val: <H3>Glossary</H3>,
    },
    {
      ...
      val: <>
        <ul>
          ...
          <li> DOM tree consists of different <i>Nodes</i>: document, documentFragment, documentType, element, text, comment.</li>
          <li><i>Element</i> is a <i>Node</i> object, which represents html tag.</li>
        </ul>
      </>,
    },
    {
    ...
    },
    {
      ...
      val: <>
        ...
        <ul>
          ...
          <li><CodeSpan>document = window.document</CodeSpan> entry point into DOM, top node</li>
          <li><CodeSpan>document.documentElement = document.querySelector('html')</CodeSpan> {'<html>'} element</li>
          <li><CodeSpan>document.head = document.querySelector('head')</CodeSpan> {'<head>'} element</li>
          <li><CodeSpan>document.body = document.querySelector('body')</CodeSpan> {'<body>'} element</li>
        </ul>
      </>,
    },
    {
    ...
    },
    {
      ...
      val: <>
        DOM elements can be selected by CSS selectors via following methods
        <ul>
          <li><CodeSpan>el.querySelectorAll('selector')</CodeSpan> returns a <b>static</b> Collection of els or or an empty NodeList if no matches.</li>
          <li><CodeSpan>el.querySelector('selector')</CodeSpan> returns the first el or <code>null</code> if no matches. Same as <CodeSpan>el.querySelectorAll('selector')[0]</CodeSpan></li>
          <li><CodeSpan>document.getElementById('id')</CodeSpan> returns an el with id or <code>null</code> if no matches.</li>
          <li><CodeSpan>el.getElementsByClassName('className')</CodeSpan> returns a <b>live</b> Collection of elements with the given class name.</li>
          <li><CodeSpan>el.getElementsByTagName('tagName')</CodeSpan> returns a <b>live</b> Collection of elements with the given tag name or <code>null</code> if no matches. Tag can be <code>*</code> for any tags.</li>
          <li><CodeSpan>document.getElementsByName('nameVal')</CodeSpan> returns a <b>live</b> Collection of elements with a given name attribute.</li>
        </ul>
      </>,
    },
    {

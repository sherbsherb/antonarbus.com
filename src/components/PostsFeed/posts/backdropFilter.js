...
function Cmpt() {
  ...
  const [brightnessState, SETbrightnessState] = React.useState({ checked: false, cssVal: 160 })
  const [contrastState, SETcontrastState] = React.useState({ checked: false, cssVal: 400 })
  const [dropShadowState, SETdropShadowState] = React.useState({ checked: false, cssVal: '10px 10px 10px black' })
  const [grayscaleState, SETgrayscaleState] = React.useState({ checked: false, cssVal: 90 })
  const [hueRotateState, SEThueRotateState] = React.useState({ checked: false, cssVal: 120 })
  const [invertState, SETinvertState] = React.useState({ checked: false, cssVal: 70 })
  const [opacityState, SETopacityState] = React.useState({ checked: false, cssVal: 20 })
  const [sepiaState, SETsepiaState] = React.useState({ checked: false, cssVal: 90 })
  const [saturateState, SETsaturateState] = React.useState({ checked: false, cssVal: 80 })
